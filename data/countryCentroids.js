(() => {
  ...
  { names: ['iceland', 'is'], iso2: 'IS', continent: 'Europe', lat: 64.9, lon: -18.6 },
  { names: ['luxembourg', 'lu'], iso2: 'LU', continent: 'Europe', lat: 49.8, lon: 6.1 },
  { names: ['andorra', 'ad'], iso2: 'AD', continent: 'Europe', lat: 42.5, lon: 1.5 },
  { names: ['monaco', 'mc'], iso2: 'MC', continent: 'Europe', lat: 43.7, lon: 7.4 },
  ...
  { names: ['hungary', 'hu'], iso2: 'HU', continent: 'Europe', lat: 47.2, lon: 19.1 },
  ...
  { names: ['croatia', 'hr'], iso2: 'HR', continent: 'Europe', lat: 45.1, lon: 15.2 },
  { names: ['bosnia and herzegovina', 'bosnia', 'ba'], iso2: 'BA', continent: 'Europe', lat: 44.2, lon: 17.7 },
  { names: ['serbia', 'rs'], iso2: 'RS', continent: 'Europe', lat: 44.0, lon: 21.0 },
  { names: ['montenegro', 'me'], iso2: 'ME', continent: 'Europe', lat: 42.7, lon: 19.3 },
  { names: ['north macedonia', 'macedonia', 'mk'], iso2: 'MK', continent: 'Europe', lat: 41.6, lon: 21.7 },
  { names: ['albania', 'al'], iso2: 'AL', continent: 'Europe', lat: 41.2, lon: 20.2 },
  { names: ['greece', 'gr'], iso2: 'GR', continent: 'Europe', lat: 39.1, lon: 22.0 },
  { names: ['bulgaria', 'bg'], iso2: 'BG', continent: 'Europe', lat: 42.7, lon: 25.5 },
  { names: ['romania', 'ro'], iso2: 'RO', continent: 'Europe', lat: 45.9, lon: 24.9 },
  { names: ['moldova', 'md'], iso2: 'MD', continent: 'Europe', lat: 47.2, lon: 28.4 },
  { names: ['slovakia', 'sk'], iso2: 'SK', continent: 'Europe', lat: 48.7, lon: 19.7 },
  { names: ['estonia', 'ee'], iso2: 'EE', continent: 'Europe', lat: 58.7, lon: 25.0 },
  { names: ['latvia', 'lv'], iso2: 'LV', continent: 'Europe', lat: 56.9, lon: 24.6 },
  { names: ['lithuania', 'lt'], iso2: 'LT', continent: 'Europe', lat: 55.2, lon: 23.9 },
  { names: ['malta', 'mt'], iso2: 'MT', continent: 'Europe', lat: 35.9, lon: 14.4 },
  { names: ['cyprus', 'cy'], iso2: 'CY', continent: 'Europe', lat: 35.1, lon: 33.4 },
  { names: ['san marino', 'sm'], iso2: 'SM', continent: 'Europe', lat: 43.9, lon: 12.4 },
  { names: ['vatican city', 'vatican', 'va'], iso2: 'VA', continent: 'Europe', lat: 41.9, lon: 12.5 },
